...
/**
 * Stateless security configuration. Public endpoints: login and the actuator/H2 console.
 * All other endpoints require a valid JWT; ADMIN-only endpoints add method-level checks
